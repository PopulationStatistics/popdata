...
knitr::kable(refugees_myr_reg , caption = "Regional Summary: Refugees-Like" )
```
...
knitr::kable(refugees_myr_reg , caption = "Regional Summary: Individual asylum applications" )
```
...
knitr::kable(refugees_myr_reg , caption = "Regional Summary: Asylum Seekers-RSD not required" )
```
...
knitr::kable(refugees_myr_reg , caption = "Regional Summary: Internally displaced persons (IDPs)" )
```
...
knitr::kable(refugees_myr_reg , caption = "Regional Summary: Returnee persons" )
```
...
knitr::kable(refugees_myr_reg , caption = "Regional Summary: Stateless persons" )
```
...
knitr::kable(refugees_myr_reg , caption = "Regional Summary: Other persons of concern to UNHCR" )
```
...
knitr::kable(refugees_myr_reg , caption = "Regional Summary: Other people in need of international protection" )
```
...
knitr::kable(refugees_myr_reg , caption = "Regional Summary: Host Community" )
```
...
table <- data.frame(
  population.type <- c("Refugees", "Asylum-seekers",  "IDPs",
                        "Stateless persons",
                       "Returned refugees and IDPs",
                       "Other of concern",
                       "Other in Need of International Protection"),
  poptype <- c("REF, ASY", "IDP", "STA", "RET", "OOC", "OIP" ),
  total <- c( 
